...
public class TestPythonUDFOutputAnnotation extends ScriptingUDFOutputAnnotationBase {

    private final ScriptingType type = ScriptingType.PYTHON;
    ...
    public void testScript1() throws Exception {
        ...
        String[] statements = {
                ...
                "B = FOREACH A GENERATE pythonudfs.simple1(i);"
        };
    ...
    public void testScript2() throws Exception {
        ...
        String[] statements = {
                ...
                "B = FOREACH A GENERATE pythonudfs.simple2(c);"
        };
    ...
    public void testScript3() throws Exception {
        ...
        String[] statements = {
                "A = LOAD 'data' USING mock.Storage() AS (c: chararray);",
                "B = FOREACH A GENERATE pythonudfs.simple3(c);"
        };
    ...
    public void testScript4() throws Exception {
        ...
        String[] statements = {
                "A = LOAD 'data' USING mock.Storage() AS (c: chararray);",
                "B = FOREACH A GENERATE pythonudfs.test_tup1(c);"
        };
    ...
    public void testScript5() throws Exception {
        ...
        String[] statements = {
                "A = LOAD 'data' USING mock.Storage() AS (c: chararray);",
                "B = FOREACH A GENERATE pythonudfs.test_tup2(c);"
        };
    ...
    public void testScript6() throws Exception {
        ...
        String[] statements = {
                "A = LOAD 'data' USING mock.Storage() AS (c: chararray);",
                "B = FOREACH A GENERATE pythonudfs.test_tup3(c);"
        };
        ...
        int magic = 3;
        int outerSchemaId = getEvalFuncNextSchemaId() + magic;
        Schema input = new Schema();
        input.add(new Schema.FieldSchema("num", DataType.LONG));
        input.add(new Schema.FieldSchema("test_tup3_c_" + (outerSchemaId + 1), DataType.CHARARRAY));

        Schema expected = new Schema(new Schema.FieldSchema("t_" + outerSchemaId, input, DataType.TUPLE));
        execute(type, scriptDef, statements, "B", data, expected);
